...
/**
 * \file    test/phpunit/MassManufacturingOrdersFunctionalTest.php
...
/**
 * Class MassManufacturingOrdersFunctionalTest
 *
 ...
 *
 * @package Testmassmanufacturingorders
 */
class MassManufacturingOrdersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMassManufacturingOrders')->click();
		} else {
			// Disable the module
			$this->byHref('modMassManufacturingOrders')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/massmanufacturingorders/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('massmanufacturingorders/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/massmanufacturingorders/admin/about.php');
		$this->authenticate();
		return $this->assertContains('massmanufacturingorders/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('massmanufacturingorderswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMassManufacturingOrders_MassManufacturingOrdersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMassManufacturingOrders_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
