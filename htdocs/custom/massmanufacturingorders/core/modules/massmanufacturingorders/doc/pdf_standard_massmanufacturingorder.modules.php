...
/**
 *  \file       core/modules/massmanufacturingorders/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_massmanufacturingorder
 */
class pdf_standard_massmanufacturingorder extends ModelePDFMassManufacturingOrder
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->massmanufacturingorders->dir_output.'/massmanufacturingorder') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->massmanufacturingorders->dir_output.'/massmanufacturingorder';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->massmanufacturingorders->dir_output.'/massmanufacturingorder/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('MASSMANUFACTURINGORDERS_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('MASSMANUFACTURINGORDERS_DRAFT_WATERMARK')));
		}
