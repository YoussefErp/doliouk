...
/**
 *   	\file       massmanufacturingorder_list.php
 *		\ingroup    massmanufacturingorders
 *		\brief      List page for massmanufacturingorder
 */
...
require_once __DIR__.'/class/massmanufacturingorder.class.php';
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('massmanufacturingorders', 'massmanufacturingorder', 'write');
	$permissiontodelete = $user->hasRight('massmanufacturingorders', 'massmanufacturingorder', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (!isModEnabled("massmanufacturingorders")) {
	accessforbidden('Module massmanufacturingorders not enabled');
}
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'MassManufacturingOrder';
	$objectlabel = 'MassManufacturingOrder';
	$uploaddir = $conf->massmanufacturingorders->dir_output;
...
$title = $langs->trans("MassManufacturingOrders");
//$help_url = "EN:Module_MassManufacturingOrder|FR:Module_MassManufacturingOrder_FR|ES:Módulo_MassManufacturingOrder";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/massmanufacturingorders/massmanufacturingorder_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/massmanufacturingorders/massmanufacturingorder_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendMassManufacturingOrderRef";
$modelmail = "massmanufacturingorder";
$objecttmp = new MassManufacturingOrder($db);
