...
<script nonce="62a5d6fd" async src="/javascript.js.php"></script>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 6); dolWebsiteIncrementCounter(1, "page", 6);
// END PHP ?>
