...
<link rel="canonical" href="/footer.php" />
<?php if ($_SERVER["PHP_SELF"] == "/footer.php") { ?>
<link rel="alternate" hreflang="fr" href="<?php echo $website->virtualhost; ?>/footer.php" />
<?php } ?>
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 3); dolWebsiteIncrementCounter(3, "other", 3);
// END PHP ?>
