...
<link rel="canonical" href="/menu.php" />
<?php if ($_SERVER["PHP_SELF"] == "/menu.php") { ?>
<link rel="alternate" hreflang="fr" href="<?php echo $website->virtualhost; ?>/menu.php" />
<?php } ?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="/image/Bpo/breakfast/lucas-swennen-1W_MyJSRLuQ-unsplash.jpg"
                                    class="img-fluid menu-image"
                                    alt=""
                                />
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="image/Bpo/lunch/louis-hansel-cH5IPjaAYyo-unsplash.jpg"
                                    class="img-fluid menu-image"
                                    alt=""
                                />
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="image/Bpo/lunch/louis-hansel-rheOvfxOlOA-unsplash.jpg"
                                    class="img-fluid menu-image"
                                    alt=""
                                />
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="menu-thumb">
                                <img
                                    src="image/Bpo/dinner/farhad-ibrahimzade-isHUj3N0194-unsplash.jpg"
                                    class="img-fluid menu-image"
                                    alt=""
                                />
...
<?php // BEGIN PHP
$tmp = ob_get_contents(); ob_end_clean(); dolWebsiteOutput($tmp, "html", 6); dolWebsiteIncrementCounter(3, "page", 6);
// END PHP ?>
